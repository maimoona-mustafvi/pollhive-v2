    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (global._io)
                        return [2 /*return*/, global._io];
                    io = new socket_io_1.Server(httpServer, {
                        cors: { origin: '*', methods: ['GET', 'POST'] },
                        path: '/api/socketio',
                    });
                    pubClient = (0, redis_1.createClient)({ url: (_a = process.env.REDIS_URL) !== null && _a !== void 0 ? _a : 'redis://localhost:6379' });
                ...
                case 1:
                    ...
                    io.on('connection', function (socket) {
                        socket.on('join_room', function (roomCode) {
                            socket.join(roomCode);
                        });
                        socket.on('leave_room', function (roomCode) {
